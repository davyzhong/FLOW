/**
 * FLOW README 渲染截图（Playwright）
 *
 * 用途：
 *   FLOW 是 Web 应用（FastAPI + Next.js 财务分析平台），没有本地可执行入口。
...
const REPO_URL = 'https://github.com/davyzhong/FLOW';
...
const SCREENSHOT_CONFIG = [
  {
    ...
    selector: 'article',
    description: 'FLOW README 桌面端渲染快照（1280×800）',
  },
  {
    name: 'readme-mobile.png',
    viewport: { width: 390, height: 844 }, // iPhone 14 视口
    selector: 'article',
    description: 'FLOW README 移动端渲染快照（390×844）',
  },
];
...
async function main() {
  console.log(`📸 FLOW README 截图自动化（Playwright）`);
