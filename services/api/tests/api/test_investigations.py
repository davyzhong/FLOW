...
async def test_investigation_api_full_review_flow(analysis_session: Session) -> None:
    ...
    async with AsyncClient(transport=transport, base_url="http://test") as client:
        ...
        rejected = await client.post(
            ...
            json={"decision": "rejected", "reviewer": "flow-dev-bp", "comment": "口径存疑"},
        )
        ...
        blocked = await client.post(
            ...
            json={"decision": "approved", "reviewer": "flow-dev-bp"},
        )
        ...
        submitted = await client.post(
            f"/api/v1/investigations/{finding_id}/transition",
            json={"decision": "submitted", "reviewer": "flow-dev-bp"},
        )
        ...
        reverified = await client.post(
            f"/api/v1/investigations/{finding_id}/evidence/{evidence_id}/decision",
            json={"decision": "verified", "reviewer": "flow-dev-bp", "comment": "审批单已归档"},
        )
        ...
        approved = await client.post(
            f"/api/v1/investigations/{finding_id}/transition",
            json={"decision": "approved", "reviewer": "flow-dev-bp", "comment": "同意签发"},
        )
