...
| 2b | [大麦数据后的剩余体验收口](work_items/UX--post-damai-experience-closeout.md) | **active（Gate 1 干净SHA复验待完成；Gate 2 静态事实完成；Gate 3 部分完成）** | G2 ✓；用户于 2026-09-26 批准实施 | FY2025工作台500已在`48f8363`修复（7/7 API测试）；新发行财报每份51行，指标覆盖FY2025 37/40、FY2026 40/40。静态 canonical 财务实际768条，月度 OCF 已进入快照；canonical 25项、粒度对账3项、发行包检查、隔离 seed/verify 19/19和浏览器 E2E 9/9全通过。验收确认 OCF KPI available、12个月趋势 complete且每月 OCF 值 available。常驻库仍是旧事实；毛利矩阵 grain/comparison 缺失尚待 Gate 3 追查。见[证据记录](../60_delivery/verification/2026-09-26--damai-visibility-gate1-v1.md)。 |
