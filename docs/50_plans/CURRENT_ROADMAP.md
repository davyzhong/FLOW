...
1. **U4 版式修复与新留出**（上表 1'）：`cn_ashare_table` 支持「合并及公司」合版标题 + 年报页码提示区间参数化；原三样本转为回归集；新留出候选已由可复现抽签产生（2026-09-25，裁决 4A）：首选小米集团 2026 中期报告（新公司）+ 阿里巴巴 FY2027 Q1 季度业绩（新期间），备选韵达/京东物流中报；抽签记录与启用规则见 [holdout-lottery-2026-09-25](../../validation/financial_reports/holdout-lottery-2026-09-25.md)。
