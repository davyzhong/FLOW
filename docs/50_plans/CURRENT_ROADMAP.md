...
> 2026-09-26 更新：常驻开发库受控恢复已完成，verify19/19两次通过；dashboard API 200、8卡、趋势12/12、2条findings，仍degraded；静态覆盖37/40与40/40。经营分析的点余额角色和派生指标依赖缺陷已修复，FY2026七项运营效率指标现可算；比率单位格式和主题缺口文案已区分公开披露不足/内部数据授权/期间缺口。正式报告产物历史仍为空，其他页面金额/数量格式待审计。隔离大麦全旅程verify19/19、E2E9/9；Gate1全路由矩阵、其他页面缺口与深链批次三仍未关闭。CI按最新SHA核验。
...
| 2b | [大麦数据后的剩余体验收口](work_items/UX--post-damai-experience-closeout.md) | **active（Gate 1全路由干净SHA复验待完成；Gate 2静态事实完成；Gate 3部分完成；Gate 4批次历史clean-SHA通过、其余下钻待完成；Gate 5待本轮提交SHA CI）** | G2 ✓；用户于 2026-09-26 批准实施 | 常驻库备份后幂等恢复，verify19/19两次，重复seed零增长。Dashboard API 200（8卡、趋势12/12、2 findings，degraded）；常驻3000端口数据批次、调查Finding、财报及经营快照可见。经营分析点余额与派生公式依赖缺陷已修复，FY2026七项运营效率指标均可算；比率单位格式和公开披露不足/内部授权/期间缺口文案已区分。未发布比较值显式标记“未发布”（Web Vitest 134/134）；正式报告产物历史为空、其他页面金额/数量格式仍待审计。公式修复SHA隔离旅程verify19/19、E2E9/9。Gate1全路由矩阵、其余页面缺口/下钻与深链批次三待处理。见[工作包](work_items/UX--post-damai-experience-closeout.md)。 |
