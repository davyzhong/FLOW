...
| 2a | [大麦物流完整财年演示数据](work_items/DAMAI--full-year-demo.md) | **active** | 已批准规格；不依赖公开 C 级 | 当前已有画像、生成器、闭合财报、静态包和部分装载链；D1–D3 仍需修正聚合维度、`DAMAI.SYN` 独立身份、正式审核链、原子幂等 seed、八页面 E2E 和最终 CI。合成数据只用于产品全链验证，不解除公开 C 级或真实企业门禁 |
