...
## 顺序与状态（2026-09-26 对 main `3ff95115` 核对；该 SHA 的 CI 状态须单独核验）
...
| 2b | [大麦数据后的剩余体验收口](work_items/UX--post-damai-experience-closeout.md) | **active（Gate 1 复验待完成；Gate 2 静态事实完成）** | G2 ✓；用户于 2026-09-26 批准实施 | FY2025工作台500已在`48f8363`修复（7/7 API测试）；新发行财报每份51行，指标覆盖FY2025 37/40、FY2026 40/40，24项相关测试通过。静态发行工件尚待隔离发布导入/页面验收；驾驶舱快照缺项进入Gate 3。见[证据记录](../60_delivery/verification/2026-09-26--damai-visibility-gate1-v1.md)。 |
