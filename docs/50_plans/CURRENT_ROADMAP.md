...
| 2 | 战略边界重构门禁（D053 阶段 1） | **gated(U08 完成后)** | U08 | 冻结 U8；重构三层两模块边界；先发布 Financial Facts Contract V2 与安全/权限子规格；[设计 §13](../superpowers/specs/2026-09-13-flow-strategic-reset-design.md#13-执行顺序) |
