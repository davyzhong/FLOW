...
批次二提交 `7976691` 推送后，在该代码版本上另跑隔离的大麦全旅程：新 Compose 卷完成迁移与 seed，verify 19/19、浏览器 E2E 9/9。证明大麦主演示旅程未被本批次破坏；不代表 Gate 1逐路由覆盖矩阵完成。其对应 CI run `36225466153` 当时仍在运行，需以最终状态为准。
