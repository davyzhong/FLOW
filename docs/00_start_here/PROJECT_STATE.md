...
截至 2026-09-26，远端 `main` 当前基线为 `3ff95115`，迁移头为 `0030_page_anchor_vocabulary`；该 SHA 的 CI 需按同一 SHA 单独核验。U8、S01、前端一致性 Task 0–9、大麦数据包和常驻库 G2 已完成；测试库隔离已于 `b60c51b` 修复，新的小米 2026H1 与阿里 FY2027Q1 holdout 已冻结并录入独立 oracle（`926af825`）。公开 C 级交叉评的42项确认异常已在 `4111f6a` 判定为真实抽取错误；109项口径疑点待裁决，京东物流200格英文原件已于 `b161fff` 冻结、待重核，抽取修订和新留出盲测未完成。大麦数据合同有24个月经营明细（1,920实际、10,752预算、4,800应收回款、672财务实际）；运行 API 初查显示两份年度报表、指标覆盖22/40与25/40。驾驶舱8张KPI卡，12个月趋势点（每点4指标），其中OCF趋势12/12缺失、KPI预算比较4/8缺失、毛利矩阵实际22/32与比较24/32缺失，整体 `degraded`；FY2025四问工作台 API 观察到500、FY2026返回200。Gate 1 的只读诊断响应矩阵已固定，证据来自 `main@3ff95115` 加未提交工作树 overlay（SHA-256 `1ede2648…`），不是干净提交验收；FY2025 工作台500根因和缺口逐项归因仍待完成。后续主线只在 `main` 串行推进。
