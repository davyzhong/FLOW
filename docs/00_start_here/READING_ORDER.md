...
4. [战略重构设计 V1.1](../superpowers/specs/2026-09-13-flow-strategic-reset-design.md) —— 当前最高产品方向、量化出口与真实企业验证协议；现行机器合同见 [财务事实合同 V1](../superpowers/specs/financial-facts-contract.md)，内部工作台前置 V2 尚待设计
