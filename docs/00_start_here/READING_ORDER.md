...
4. [战略重构设计 V1.1](../superpowers/specs/2026-09-13-flow-strategic-reset-design.md) —— 当前最高产品方向、量化出口与真实企业验证协议；现行机器合同见 [财务事实合同 V1](../superpowers/specs/financial-facts-contract.md)，[Facts V2](../40_specs/financial-facts/financial-facts-contract-v2.md) 已批准并实现基础模型，安全规格 V1.1 正在 Gate 0 独立审查
