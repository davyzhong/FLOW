...
## 横向盘点与优化建议（2026-09-14）

- [相似项目盘点与方法框架总结](2026-09-14-similar-projects-and-frameworks.md)：按目标相似度横向盘点开源与外部产品（FinRobot、Bigcapital、Wren AI/Vanna/DB-GPT、Copilot for Finance/Numeric 等），抽象行业五层骨架并与 FLOW 三层两模块逐层比对。
- [竞对比对优化清单](2026-09-14-optimization-backlog.md)：17 项优化建议（O-01～O-17，含来源/落点/优先级），执行受 D053 门禁与 D049/D054 纪律约束，非任务批准。
