...
## 统一整合与来源可信度（2026-09-07）

[累计参考与订正总册](../02_research/synthesis/2026-09-07-reference-and-improvement-master.md)以 S00–S20 登记来源家族、A–E 标记证据等级，附录保留当前公众号索引 417 条引用。新增针对性官方核验为 IFRS 18 MPM 范围；FCF/单独比率与一般管理指标须区分。FineBI 登录资料包、未取得的文章图片、仅索引条目不声明全文已核验；企业背景资料仅摘要引用，不复制私有明细。原始档案未变更。
